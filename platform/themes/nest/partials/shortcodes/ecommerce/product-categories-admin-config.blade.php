...
<div class="mb-3">
    <label class="form-label">{{ __('Scroll display items on mobile') }}</label>
    {!! Form::customSelect('scroll_items_on_mobile', array_combine([1, 2, 3], [1, 2, 3]), Arr::get($attributes, 'scroll_items_on_mobile', 2)) !!}
</div>
