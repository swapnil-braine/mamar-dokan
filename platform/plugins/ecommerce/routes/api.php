...
Route::group([
    ...
    Route::post('cart/{id}', [CartController::class, 'store'])->wherePrimaryKey();
    Route::put('cart/{id}', [CartController::class, 'update'])->wherePrimaryKey();
    Route::delete('cart/{id}', [CartController::class, 'destroy'])->wherePrimaryKey();
    Route::get('cart/{id}', [CartController::class, 'index'])->wherePrimaryKey();
    ...
    Route::group(['middleware' => ['web', 'core']], function (): void {
        Route::get('checkout/cart/{id}', [CheckoutController::class, 'process'])->wherePrimaryKey();
    });

    Route::post('orders/tracking', OrderTrackingController::class);

    Route::post('wishlist', [WishlistController::class, 'store']);
    Route::post('wishlist/{id}', [WishlistController::class, 'store'])->wherePrimaryKey();
    Route::delete('wishlist/{id}', [WishlistController::class, 'destroy'])->wherePrimaryKey();
    Route::get('wishlist/{id}', [WishlistController::class, 'index'])->wherePrimaryKey();

    Route::post('compare', [CompareController::class, 'store']);
    Route::post('compare/{id}', [CompareController::class, 'store'])->wherePrimaryKey();
    Route::delete('compare/{id}', [CompareController::class, 'destroy'])->wherePrimaryKey();
    Route::get('compare/{id}', [CompareController::class, 'index'])->wherePrimaryKey();
});
